...
return [
    ...
    */
    'bots' => [
        'mybot' => [
            'token' => env('TELEGRAM_BOT_TOKEN', '6337189847:AAFxG2YbmE1qQQZCv7VNKX8HBZAKpgJBjvw'),
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url' => env('TELEGRAM_WEBHOOK_URL', 'https://whatsapp-api.clenicode.ae/telegram/webhook'),
            'commands' => [
